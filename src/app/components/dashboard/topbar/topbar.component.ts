    ...
    <div class="h-16 bg-white shadow px-4 z-9999 flex sticky top-0 items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        <!-- <button (click)="chatService.toggle()" 
                class="group relative p-1 rounded-sm bg-gray-900/5 hover:bg-gray-900/10 border border-purple-700 text-purple-800 transition-all duration-300 flex items-center gap-2 overflow-hidden shadow-sm hover:shadow-md">
          ...
          <fa-icon [icon]="faWandSparkles" class="text-lg text-orange-600 animate-pulse"></fa-icon>
          <span class="text-xs font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-700 via-purple-800 to-orange-600 hidden md:block">
            Luna AI
          </span>
        </button> -->
